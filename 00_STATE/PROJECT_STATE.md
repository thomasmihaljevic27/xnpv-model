...
- **Plain-language overview (2026-09-24b):** `40_DOCS/Project_Overview_Plain_Language.pdf` (two pages; HTML source alongside) gives the research question, the three asset classes, what the back-test looks for, and a flow chart of each valuation path with build status, plus the rebuilt draft curve as a bar chart. Written for a non-specialist reader. See `sessions/2026-09-24b.md`.
